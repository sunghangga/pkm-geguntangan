# -*- coding: utf-8 -*-
"""
Created on Tue Sep 18 00:01:58 2018
...
def main():
	...
	rate, source = scipy.io.wavfile.read('D:/Angga/MIR/Audio Source Separation/Coding/ica-source/source.wav')
	...
	scipy.io.wavfile.write( 'D:/Angga/MIR/Audio Source Separation/Coding/ica-destination/separated_1.wav', rate, separated[:, 0] )
	scipy.io.wavfile.write( 'D:/Angga/MIR/Audio Source Separation/Coding/ica-destination/separated_2.wav', rate, separated[:, 1] )
